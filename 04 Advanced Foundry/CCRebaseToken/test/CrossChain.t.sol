...
contract CrossChainTest is Test {
    ...
    function setUp() public {
        ...
        vm.makePersistent(address(sourceRebaseToken));
        vm.makePersistent(address(sourcePool));
        ...
        // Make contracts persistent across forks
        vm.makePersistent(address(destRebaseToken));
        vm.makePersistent(address(destPool));
        vm.stopPrank();
    }
