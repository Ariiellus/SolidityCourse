...
const deployedContracts = {
  ...
  84532: {
    DEX: {
      address: "0xE914a56899f020DDE2f1577D212A945057f14239",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 34463110,
    },
    MyUSD: {
      address: "0x980f2b37Bae7c3C2DdAA2b6bfDef4e857a445057",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 34463107,
    },
    MyUSDEngine: {
      address: "0x7344F84a425D1378beaEedcf0327274b20C936bc",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 34463119,
    },
    MyUSDStaking: {
      address: "0xAEF31ced19899bDd976FbDe688a053A6b5a53D29",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 34463116,
    },
    Oracle: {
      address: "0x089EDAA82AB102f4c62eE3Dd229573835Aece043",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 34463113,
    },
    RateController: {
      address: "0xd8Be42Fb50e834263852636273F65f9a740f755B",
      abi: [
        {
          inputs: [
            {
