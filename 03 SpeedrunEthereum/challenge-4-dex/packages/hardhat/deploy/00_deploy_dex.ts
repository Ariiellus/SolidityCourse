...
const deployYourContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  // // paste in your front-end address here to get 100 balloons on deploy:
  // await balloons.transfer("Input your address here", hre.ethers.parseEther("100"));
  ...
  await balloons.approve(dexAddress, hre.ethers.parseEther("500")); // 500 $BAL is enough to init the DEX
  console.log("INIT exchange...");
  await dex.init(hre.ethers.parseEther("500"), { // send 500 $BAL to the DEX
    value: hre.ethers.parseEther("0.01"), // deployer sends 0.01 ETH to the DEX
    gasLimit: 200000,
  });
};
